...
Run after `scripts/plot_all_repos_connectivity.py` has written:
  viz_output_all_repos/all_repos_pr_connectivity_cpr_histogram.png
  viz_output_all_repos/all_repos_pr_connectivity_cpr_histogram_defined_only.png

Output:
  viz_output_all_repos/all_repos_pr_connectivity_cpr_histogram_merged.png
"""
...
ALL_NAME = "all_repos_pr_connectivity_cpr_histogram.png"
DEFINED_NAME = "all_repos_pr_connectivity_cpr_histogram_defined_only.png"
MERGED_NAME = "all_repos_pr_connectivity_cpr_histogram_merged.png"
