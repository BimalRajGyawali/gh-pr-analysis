#!/usr/bin/env python3
"""
Merge median connected-component size histograms (all PRs vs n_nodes>0 only) stacked vertically.

Run after `scripts/plot_all_repos_median_connected_component.py` has written:
...
ALL_NAME = "all_repos_pr_median_connected_component_histogram.png"
DEFINED_NAME = "all_repos_pr_median_connected_component_histogram_defined_only.png"
MERGED_NAME = "all_repos_pr_median_connected_component_histogram_merged.png"
