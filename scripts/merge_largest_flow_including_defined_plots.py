#!/usr/bin/env python3
"""
Merge largest-flow size histograms (all PRs vs n_nodes>0 only) stacked vertically.

Run after `scripts/plot_all_repos_largest_forward_flow.py` has written:
...
ALL_NAME = "all_repos_pr_largest_flow_histogram.png"
DEFINED_NAME = "all_repos_pr_largest_flow_histogram_defined_only.png"
MERGED_NAME = "all_repos_pr_largest_flow_histogram_merged.png"
