...
DEFAULT_OUT = _DEFAULT_CC / "all_repos_pr_largest_connected_component_histogram.png"
DEFAULT_OUT_DEFINED_ONLY = (
    _DEFAULT_CC / "all_repos_pr_largest_connected_component_histogram_defined_only.png"
)
